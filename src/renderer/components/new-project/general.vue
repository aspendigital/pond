    ...
    <form class="layout-flex-row layout-stretch layout-relative" @submit.prevent="goNextStep">
      <div class="layout-full-size scrollable">
        <div class="standard-panel-paddings standard-padding-bottom standard-padding-top">
          ...
          <div class="form-group required">
            <label ref="directoryLocationLabel" for="directory-location">{{
              $t('projects.create_project.directory_location') }}</label>
          ...
          <div class="form-group">
            <label v-bind:class="{active: project.description}" for="project-description">{{
              $t('projects.create_project.description') }}</label>
            <textarea id="project-description" class="form-control" type="text"
                      v-bind:placeholder="$t('projects.create_project.description_placeholder')"

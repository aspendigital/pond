        ...
        <div class="standard-panel-paddings standard-padding-bottom standard-padding-top">
          <div class="row">
            <div class="col-sm-10 col-sm-offset-1">
              <h3 class="double-padding-top new-project-done-badge">{{ $t('projects.create_project.project_ready')
                }}</h3>
              ...
              <template v-if="project.runtime.warnings">
                <h3 v-if="hasMultipleWarnings()" class="standard-padding-bottom">{{
                  $t('projects.create_project.multiple_warnings') }}</h3>
              ...
              <p>
                <a class="btn btn-primary" @click.stop.prevent="goToProject">{{
                  $t('projects.create_project.go_to_project') }}</a>
              </p>
            </div>
          </div>
        </div>
